package com.mu.tote2024.data.firebase
...
import com.mu.tote2024.utils.Constants.CURRENT_ID
import com.mu.tote2024.utils.Constants.DEBUG_TAG
import com.mu.tote2024.utils.Constants.GAMBLER
import com.mu.tote2024.utils.Constants.NODE_GAMBLERS
    ...
    override suspend fun signUp(email: String, password: String): Flow<NetworkResult<Boolean>> {
        return flow {
            ...
            try {
                ...
                Log.d(DEBUG_TAG, "CURRENT_ID: $CURRENT_ID")
